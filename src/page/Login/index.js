    ...
    <div className={style.body}>
      ...
      <div className={style.formbox} >
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <Button title={loading ? "Loading" : "Login"} type="submit" disabled={isDisabled}/>
        </form>
        <p className='text-center mx-auto my-3'>Login with</p>
        <Button title='Google' className='white'><img src={google} className="mr-2" alt="" /></Button>
        <p className='text-center mx-auto my-3'>Don't have a account ? <span onClick={() => navigate('/register')}>Sign up</span></p>
      </div>
    </div>
  )
}
